...
<?php echo $form->create('Doctor');?>
	<fieldset>
 		<legend><?php __('Edit Doctor');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action' => 'delete', $form->value('Doctor.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Doctor.id'))); ?></li>
